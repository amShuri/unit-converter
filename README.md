...
A simple unit converter for metric and imperial units — converts length (meters/feet), volume (liters/gallons), and mass (kilos/pounds).
...
Original project idea from Scrimba.
